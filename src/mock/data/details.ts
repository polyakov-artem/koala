...
export default [
  {
    ...
    reasons: [
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/reasons/mattresses/koala-plus-mattress/1.mp4`,
      ...
      {
        title: `+60% Kloudcell®`,
        mediaURL: `${PUBLIC_PATH}products/reasons/mattresses/koala-plus-mattress/2.mp4`,
      ...
      },
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/reasons/mattresses/koala-plus-mattress/3.webp`,
      ...
      },
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/reasons/mattresses/koala-plus-mattress/4.mp4`,
    ...
    advantages: [
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/advantages/mattresses/koala-plus-mattress/1.mp4`,
      ...
      {
        title: `Advanced cooling. Deep sleeping.`,
        mediaURL: `${PUBLIC_PATH}products/advantages/mattresses/koala-plus-mattress/2.webp`,
      ...
      },
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/advantages/mattresses/koala-plus-mattress/3.mp4`,
        text: `Our 2cm quilted topper is ready to tackle every season. You can simply unzip and flip it over to take you from comfy Organic Cotton when it’s chilly, to crisp CoolThread™ when it’s hot.`,
      },
      {
        title: `Choose your own comfort`,
        mediaURL: `${PUBLIC_PATH}products/advantages/mattresses/koala-plus-mattress/4.mp4`,
        text: `If our customisable seasonal topper was not enough, the Koala Plus Mattress also features our trademark double-sided Kloudcell® Comfort Layer, which gives you the choice between medium-firm and firm comfort. Simply unzip and flip the comfort layer to find your sweet spot.`,
      },
      {
        title: `Still not cool enough?`,
        mediaURL: `${PUBLIC_PATH}products/advantages/mattresses/koala-plus-mattress/5.mp4`,
    ...
    rating: 5,
    reviews: 234,
    features: [`Advanced cooling`, `with seasonal adjustment & flippable firmness`],
    firmness: [`Plush`, `+ flip to firm`],
    layers: [`Adjustable comfort layer`, `with 8cm Cooling Kloudcell®`, `+ 5-Support Zones`],
    awardsURL: [`${PUBLIC_PATH}products/awards/2.svg`, `${PUBLIC_PATH}products/awards/3.svg`],
    appearanceURL: `${PUBLIC_PATH}products/appearances/mattresses/koala-plus-mattress/layers/1.webp`,
  },
  {
    _id: `2`,
    category: `mattresses`,
    ...
    reasons: [
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/reasons/mattresses/koala-luxe-mattress/1.mp4`,
      ...
      },
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/reasons/mattresses/koala-luxe-mattress/2.mp4`,
      ...
      },
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/reasons/mattresses/koala-luxe-mattress/3.webp`,
      ...
      },
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/reasons/mattresses/koala-luxe-mattress/4.webp`,
    ...
    advantages: [
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/advantages/mattresses/koala-luxe-mattress/1.mp4`,
      ...
      },
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/advantages/mattresses/koala-luxe-mattress/2.mp4`,
      ...
      },
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/advantages/mattresses/koala-luxe-mattress/3.mp4`,
      ...
      },
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/advantages/mattresses/koala-luxe-mattress/4.mp4`,
      ...
      },
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/advantages/mattresses/koala-luxe-mattress/5.mp4`,
    ...
    rating: 5,
    reviews: 520,
    features: [`Redefining luxury sleep`, `with cashmere & copper Kloudcell®`],
    firmness: [`Plushest`],
    layers: [`Fixed comfort layer`, `with 9cm Copper Kloudcell®`, `+ 7-Support Zones`],
    awardsURL: [`${PUBLIC_PATH}products/awards/1.svg`, `${PUBLIC_PATH}products/awards/2.svg`],
    appearanceURL: `${PUBLIC_PATH}products/appearances/mattresses/koala-luxe-mattress/layers/1.webp`,
  },
  {
    _id: `3`,
    category: `mattresses`,
    ...
    reasons: [
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/reasons/mattresses/koala-mattress/1.webp`,
      ...
      },
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/reasons/mattresses/koala-mattress/2.mp4`,
      ...
      },
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/reasons/mattresses/koala-mattress/3.webp`,
      ...
      },
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/reasons/mattresses/koala-mattress/4.webp`,
    ...
    advantages: [
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/advantages/mattresses/koala-mattress/1.mp4`,
      ...
      },
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/advantages/mattresses/koala-mattress/2.mp4`,
      ...
      {
        title: `Flippable firmness`,
        mediaURL: `${PUBLIC_PATH}products/advantages/mattresses/koala-mattress/3.mp4`,
      ...
      },
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/advantages/mattresses/koala-mattress/4.mp4`,
      ...
      },
      {
        ...
        mediaURL: `${PUBLIC_PATH}products/advantages/mattresses/koala-mattress/5.mp4`,
    ...
    rating: 5,
    reviews: 345,
    features: [`Australia's top rated`, `now with partner preference`],
    firmness: [`Medium-firm`, `+ flip to firm`, `+ half-half partner preference`],
    layers: [`Adjustable comfort layer`, `with 7cm Kloudcell®`, `+ 3-Support Zones`],
    awardsURL: [`${PUBLIC_PATH}products/awards/3.svg`, `${PUBLIC_PATH}products/awards/1.svg`],
    appearanceURL: `${PUBLIC_PATH}products/appearances/mattresses/koala-mattress/layers/1.webp`,
  },
